...
public class ArmFF {
  ...
  /**
   * Creates a new ArmFF with the specified gains. Units of the gain values will dictate
  ...
  /**
   * Creates a new ArmFF with the specified gains. Acceleration gain is defaulted to zero.
   ...
   * @param kv The velocity gain.
   */
  public ArmFF(double ks, double kg, double kv) {
    this(ks, kg, kv, 0);
  }
