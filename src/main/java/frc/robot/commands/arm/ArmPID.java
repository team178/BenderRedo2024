...
// Edited by Team 178 for resettable m_totalError
...
public class ArmPID implements Sendable, AutoCloseable {
   ...
   */
  public ArmPID(double kp, double ki, double kd, double period) {
    m_kp = kp;
    m_ki = ki;
    m_kd = kd;
